        ...
        <div className="flex items-center justify-between h-16 sm:h-20 gap-2">
          ...
          <div className="flex items-center gap-2 sm:gap-6 min-w-0">
            <a href="#" className="flex items-center gap-2 sm:gap-3 group shrink-0">
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[#E06D53] to-[#C95338] flex items-center justify-center text-white shadow-md shadow-[#E06D53]/20 group-hover:scale-105 transition-transform">
                <span className="font-serif font-bold text-base sm:text-xl tracking-tight">T&T</span>
              </div>
              <div className="flex flex-col min-w-0">
                <div className="flex items-baseline gap-1">
                  <span className="font-serif font-bold text-base sm:text-2xl text-[#1E1B18] tracking-tight truncate">
                    Tiffin <span className="text-[#E06D53]">&</span> Treat
                  </span>
                  <span className="text-[9px] sm:text-[10px] font-semibold tracking-widest text-[#8C8275] uppercase px-1 sm:px-1.5 py-0.2 bg-[#F2ECE1] rounded hidden xs:inline">
                    .nz
                  </span>
                </div>
                <span className="text-[10px] sm:text-[11px] text-[#786E60] font-medium tracking-normal hidden md:block">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
            ...
            {hasActiveOrder && (
              <button
                ...
                className="flex items-center gap-1.5 py-1.5 sm:py-2 px-2 sm:px-3 rounded-full text-xs font-bold text-white bg-gradient-to-r from-emerald-600 to-teal-600 shadow-sm shadow-emerald-600/30 animate-pulse-subtle cursor-pointer hover:opacity-95 shrink-0"
              >
            ...
            <button
              ...
              onClick={onOpenCart}
              className="flex items-center gap-1.5 sm:gap-2.5 py-1.5 sm:py-2 px-3 sm:px-4 rounded-full bg-[#E06D53] hover:bg-[#D45E44] text-white font-semibold text-xs sm:text-sm shadow-md shadow-[#E06D53]/25 transition-all transform active:scale-95 cursor-pointer shrink-0"
            >
              <div className="relative">
                <ShoppingBag className="w-4 h-4" />
                {cartTotalCount > 0 && (
                  <span className="absolute -top-2 -right-2 bg-[#211E1B] text-white text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center ring-2 ring-white">
                    {cartTotalCount}
                  </span>
                )}
              </div>
              <div className="flex items-center gap-1 border-l border-white/20 pl-1.5 sm:pl-2">
                <span className="hidden sm:inline text-xs">NZD</span>
                <span className="font-bold font-mono text-xs sm:text-sm">${cartSubtotal.toFixed(2)}</span>
              </div>
            </button>
            ...
            <button
              ...
              className="lg:hidden p-1.5 sm:p-2 rounded-xl text-[#3D372E] bg-white border border-[#E8E0D2] hover:bg-[#F2ECE1] transition-colors shrink-0"
